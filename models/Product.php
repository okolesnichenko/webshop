...
class Product
{
    ...
    public static function createProduct($options)
    {
        ...
        $db->query("INSERT INTO product(name, category_id, code, price, availability, brand, image, description, 
                    is_new, is_recommended, status) VALUES 
    ...
    public static function getImage($id)
    {
        ...
        $path = '/webproject/upload/images/products/';
